...
public class ServiceRequestResultPacket extends ResponsePacket {
	...
	private boolean isUsedDestination; // 목적지정보 사용여부 (1)
	...
	public boolean isUsedDestination() {
		return isUsedDestination;
	}
	...
	public void parse(byte[] buffers) {
		...
		int usedDestination = readInt(1);
		isUsedDestination = usedDestination == 0x01;
		extra02 = readInt(1);
		extra03 = readInt(1);
		extra04 = readInt(1);
		extra05 = readInt(1);
	...
	public String toString() {
		return "서비스요청결과 (0x" + Integer.toHexString(messageType) + ") " +
				...
				", isWaiting=" + isWaiting +
				", isUsedDestination=" + isUsedDestination +
				", extra02=" + extra02 +
				", extra03=" + extra03 +
				", extra04=" + extra04 +
				", extra05=" + extra05 +
